...
const styles = StyleSheet.create({
  ...
  clearBtnText: { fontFamily: 'DMSans_600SemiBold', fontSize: 12, color: '#000000' },
  count: { fontFamily: 'DMSans_400Regular', fontSize: 14, color: colors.textSecondary },
  filterRow: {
    flexDirection: 'row',
    paddingHorizontal: spacing.md,
    gap: spacing.sm,
  ...
  emptyTitle: { fontFamily: 'DMSans_700Bold', fontSize: 22, color: colors.textPrimary, textAlign: 'center' },
  emptySub: { fontFamily: 'DMSans_400Regular', fontSize: 15, color: colors.textSecondary, textAlign: 'center', lineHeight: 22 },
  emptyBtn: {
    backgroundColor: colors.accentBlue,
  ...
  emptyBtnText: { fontFamily: 'DMSans_600SemiBold', fontSize: 16, color: '#000000' },
  ...
  modalScore: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 84, color: '#FFF', textAlign: 'center', marginVertical: spacing.lg, lineHeight: 80 },
  modalScoreOf: { fontFamily: 'DMSans_400Regular', fontSize: 28, color: 'rgba(255,255,255,0.45)' },
  modalBasis: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: 'rgba(255,255,255,0.5)', textAlign: 'center', fontStyle: 'italic', marginBottom: spacing.lg },
  modalRec: {
    flexDirection: 'row',
    gap: spacing.sm,
  ...
  modalRecNum: { fontFamily: 'DMSans_700Bold', fontSize: 14, color: colors.accentBlue, width: 18 },
  modalRecText: { fontFamily: 'DMSans_400Regular', fontSize: 14, color: '#FFF', flex: 1, lineHeight: 21 },
  modalNudge: {
    flexDirection: 'row',
...
const calStyles = StyleSheet.create({
  ...
  monthTitle: { fontFamily: 'DMSans_700Bold', fontSize: 14, color: colors.textPrimary },
  ...
  dayText: { fontFamily: 'DMSans_500Medium', fontSize: 13, color: colors.textPrimary },
  dayTextSelected: { fontFamily: 'DMSans_700Bold', color: '#000000' },
  dayTextToday: { fontFamily: 'DMSans_700Bold', color: colors.accentDark },
  dot: {
    width: 4,
    height: 4,
    borderRadius: 2,
